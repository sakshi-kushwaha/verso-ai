export default function Input({ label, type = 'text', value, onChange, placeholder, iconL, iconR, onIconR }) {
  return (
    <div className="mb-4">
      {label && <label className="block text-xs font-semibold text-text-muted uppercase tracking-wide mb-1.5">{label}</label>}
      <div className="flex items-center gap-2.5 bg-surface border border-border rounded-lg px-3.5">
